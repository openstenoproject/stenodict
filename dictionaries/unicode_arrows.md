...
Output unicode arrows instead of trying to draw them with other symbols (->, <=, etc.)

Full list: ←↑→↓↔↕↖↗↘↙⇄

## Why

The only reason that these arrows aren't more widely used is the difficulty of activating them with a regular keyboard. Stenography allows us to make this trivially easy. Think of the pretty documents you could write, or the silly puns that you could make. All that's ← is for you to come ↑ with ideas of how to use them!
...
## [Download Unicode Arrows](unicode_arrows.json)